...
(function attachPromptHelp() {
  ...
  tables[3].positionHelp = {
    ...
    2: 'One partner on hands-and-knees (or leaning forward); the other behind. Allows deeper angle; check in about comfort and depth.',
    3: 'Receiving partner straddles the other face-to-face. They control depth and pace; the other can touch and kiss.',
    4: 'Receiving partner on top facing away. Different angle and sensation; the person on bottom can touch their partner’s body.',
    ...
    11: 'Like missionary but bodies shifted so the clitoris gets contact. Shallow, sustained movement rather than deep thrusting. Research “CAT position” for details.',
    ...
    14: 'Bodies or genitals rubbing together (e.g. between thighs, stomachs, or genitals) with no penetration. Build rhythm and pressure together.',
    15: 'Thrusting or rubbing between the receiving partner’s closed thighs. No penetration; the receiving partner controls squeeze and angle.',
    16: 'Genital-to-genital rubbing (e.g. legs interlocked or overlapping). No penetration; find a rhythm that works for both.',
    ...
    20: 'Both standing, facing each other in a close embrace (e.g. against a wall). Full body contact; movement can be rocking or grinding.'
  };
  ...
  window.getPromptHelp = function (phase, type, roll) {
    ...
    if (type === 'where') {
      if (phase === 3) return (p.positionHelp && p.positionHelp[r]) || (p.positions && p.positions[r]) || '';
